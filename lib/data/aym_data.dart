final List<Map<String, String>> aymData = [
  {
    ...
    'description':
        'Kullanıcı, metinde dil (örneğin İngilizce) ifadesi geçen metine basılı tuttuğunda bir diyalog açılır ve bu diyalogda mevcut dili düzenleyebilir. Örneğin, [Dil: İngilizce] kısmı üzerinde düzenleme yaparak başka bir dil girebilir. Bu işlem sonrasında metin anında güncellenir ve kullanıcıya yaptığı değişikliği hemen görme imkanı sunar.',
    ...
    'description3':
        'Eklediğiniz metin ana sayfada sadece bir dil (İngilizce) olarak gözükecektir. Metnin üzerine basılı tutarak dili değiştirebilirsiniz.',
  },
  {
    'title': 'Etkileşimli İsim Düzenleyici',
    'description':
        'Kullanıcı, metinde isim (örneğin Mehmet) ifadesi geçen metine basılı tuttuğunda bir diyalog açılır ve bu diyalogda mevcut ismi düzenleyebilir. Örneğin, [İsim: Mehmet] kısmı üzerinde düzenleme yaparak başka bir isim girebilir. Bu işlem sonrasında metin anında güncellenir ve kullanıcıya yaptığı değişikliği hemen görme imkanı sunar.',
    'subtitle': 'Kullanım Kılavuzu',
    ...
    'description3':
        'Eklediğiniz metin ana sayfada sadece bir isim (Mehmet) olarak gözükecektir. Metnin üzerine basılı tutarak ismi değiştirebilirsiniz.',
  },
  {
